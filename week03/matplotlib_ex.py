...
plt.title('Age and Fare Reationship with Survival on Titanic')
plt.xlabel('Age')
plt.ylabel('Fare')
...
plt.title('Survived Distribution on the Titanic')
...
## **영역 채우기 그래프 : 나이대별 생존자수 사망자 수 표현하기**
...
axes[1].tick_params('Survived Count', color='deeppink')
